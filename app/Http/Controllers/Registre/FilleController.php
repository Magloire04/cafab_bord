...
use App\Http\Requests\Registre\StoreFilleRequest;
use App\Http\Requests\Registre\UpdateFilleRequest;
...
class FilleController extends Controller
{
    public function index(): View
    {
        ...
        return view('registre.filles.index', compact('filles'));
    }

    public function create(): View
    {
        return view('registre.filles.create');
    }
    ...
    public function store(StoreFilleRequest $request, PinGenerator $pinGenerator): RedirectResponse
    {
        ...
        return redirect()->route('filles.index')->with('message', 'Fille ajoutée.');
    }

    public function edit(Fille $fille): View
    {
        return view('registre.filles.edit', compact('fille'));
    }
    ...
    public function update(UpdateFilleRequest $request, Fille $fille): RedirectResponse
    {
        ...
        return redirect()->route('filles.index')->with('message', 'Fiche mise à jour.');
    }

    public function toggleStatut(Fille $fille): RedirectResponse
    {
        Gate::authorize('toggleStatut', $fille);
        ...
        return redirect()->route('filles.index')->with('message', 'Statut mis à jour.');
    }
    ...
    public function regeneratePin(Fille $fille, PinGenerator $pinGenerator): RedirectResponse
    {
        ...
        return redirect()->route('filles.index')->with('message', 'Nouveau code PIN généré.');
    }
}
